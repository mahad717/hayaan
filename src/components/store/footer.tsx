  ...
  return (
    <footer className="mt-auto bg-brand-dark text-[#faf8f1]">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        {/* AEO note (Task 77 repositioned): the site-wide buyer FAQ moved out
            of the footer into the homepage content flow (StorefrontApp home
            view) — inside the footer it rendered on every page directly above
            the link columns, which read as a footer element in the wrong
            spot. The homepage FAQPage JSON-LD still matches visible content
            there; category and blog pages keep their own in-content FAQs. */}
