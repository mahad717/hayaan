...
const en = {
  ...
  "co.cityPlaceholder": "Pick your city…",
  "co.cityOther": "Other city (not listed)",
  "co.cityTypePlaceholder": "Type your city",
  "co.areaOther": "Other area (not listed)",
  "co.area": "Area / Neighborhood",
  "co.areaPlaceholder": "e.g. Siinaay",
  ...
  "acc.toastCityRequired": "Please choose your city so we can deliver your order.",
  "acc.toastDistrictRequired": "District is required for Mogadishu deliveries — please pick your district.",
  "acc.toastAreaRequired": "Please write your area so the courier can find you.",
...
const so: Record<DictKey, string> = {
  ...
  "co.cityPlaceholder": "Dooro magaaladaada…",
  "co.cityOther": "Magaalo kale (liiska ku jirin)",
  "co.cityTypePlaceholder": "Qor magaaladaada",
  "co.areaOther": "Aag kale (liiska ku jirin)",
  "co.area": "Aagga / Xaafada",
  "co.areaPlaceholder": "tusaale: Siinaay",
  ...
  "acc.toastCityRequired": "Fadlan dooro magaaladaada si aan u soo gaadhinno dalabkaaga.",
  "acc.toastDistrictRequired": "Degmada waa lama huraan gaadhitaanka Muqdisho — fadlan dooro degmadaada.",
  "acc.toastAreaRequired": "Fadlan qor aaggaaga si gaadhigu ku heli karo.",
