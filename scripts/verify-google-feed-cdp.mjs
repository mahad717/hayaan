// Task 62 live verify: Google Merchant feed — render /feeds/google-products.xml
// in real Chrome for the record + console health.
...
const URL_ = "view-source:https://hayaan.co/feeds/google-products.xml";
const OUT = "/home/z/my-project/download/task62-google-feed.png";
...
const chrome = spawn(CHROME, [
  ...
  `--user-data-dir=/tmp/chrome-t62-${Date.now()}`,
...
await sleep(5000);
// view-source: renders the raw XML as plain text (the DOM tree view is too
// slow for a 94-item feed). Byte-level validation already done via curl+python.
await shot(OUT);
